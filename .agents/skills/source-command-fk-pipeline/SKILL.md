---
name: "source-command-fk-pipeline"
description: "Migrated source command `fk-pipeline`"
---

# source-command-fk-pipeline

Use this skill when the user asks to run the migrated source command `fk-pipeline`.
...
Use the Agent tool with `oh-my-Codex:executor` for Track B:

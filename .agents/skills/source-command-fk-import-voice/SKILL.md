---
name: "source-command-fk-import-voice"
description: "Migrated source command `fk-import-voice`"
---

# source-command-fk-import-voice

Use this skill when the user asks to run the migrated source command `fk-import-voice`.

---
name: "source-command-fk-refresh-urls"
description: "Migrated source command `fk-refresh-urls`"
---

# source-command-fk-refresh-urls

Use this skill when the user asks to run the migrated source command `fk-refresh-urls`.

...
description: "Trim each scene video to fit its TTS narrator duration, burn text overlays, then concatenate into a final video."
---

<!-- AUTO-GENERATED by setup.py — do not edit. Source: skills/fk-concat-fit-narrator.md -->

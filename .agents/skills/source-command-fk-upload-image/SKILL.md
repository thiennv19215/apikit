---
name: "source-command-fk-upload-image"
description: "Migrated source command `fk-upload-image`"
---

# source-command-fk-upload-image

Use this skill when the user asks to run the migrated source command `fk-upload-image`.

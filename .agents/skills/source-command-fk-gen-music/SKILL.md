---
name: "source-command-fk-gen-music"
description: "Migrated source command `fk-gen-music`"
---

# source-command-fk-gen-music

Use this skill when the user asks to run the migrated source command `fk-gen-music`.

---
name: fk-doctor
description: "Diagnose any FlowKit error and prescribe a fix. Knows the full error taxonomy across Google Flow, the Chrome extension, the FastAPI layer, the worker, and the YouTube upload pipeline."
---

<!-- AUTO-GENERATED by setup.py — do not edit. Source: skills/fk-doctor.md -->

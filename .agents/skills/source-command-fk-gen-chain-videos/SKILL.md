---
name: "source-command-fk-gen-chain-videos"
description: "Migrated source command `fk-gen-chain-videos`"
---

# source-command-fk-gen-chain-videos

Use this skill when the user asks to run the migrated source command `fk-gen-chain-videos`.

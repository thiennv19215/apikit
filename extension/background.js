...
async function initialize() {
  ...
  if (data.installationId) {
    ...
    installationId = 'inst_' + (globalThis.crypto?.randomUUID ? crypto.randomUUID() : Math.random().toString(36).slice(2) + Date.now().toString(36));
    void chrome.storage.local.set({ installationId });
  }
  try {

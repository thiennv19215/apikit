...
| `UNSUPPORTED_ON_BATCH_API: Upscale` | Video 4K/1080p upscale payload was never captured off the new UI | **Terminal — not retried** | Keep 1080p output. Upscale has no batch RPC payload yet. |
